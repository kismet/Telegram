...
public class Server {
	...
	static class ClientHandler implements Runnable {
		...
		public void run() {
			...
			String message = null;
			//Se writer è null vuol dire che è caduta la connessione ed è inutile andare avanti ogni operazione fallira
			while (writer != null) {
		...
		private String doReadCommand() {
			byte[] buffer = new byte[1024];
			int count = 0;
			String anotherPath = "C:\\Users\\Sara\\Documents\\scuola\\twepsit\\informazioni\\info.txt";
			// va cambiato
			// con quello
			// del pc in uso
			...
			try {
				...
				String message = Files
						.readString(Paths.get("C:\\Users\\Sara\\Documents\\scuola\\twepsit\\telegram\\miofile.txt")); // dovrebbe
																														// leggere
																														// il
																														// contenuto
																														// del
